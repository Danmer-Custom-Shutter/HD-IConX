...
Module Module1
    ...
    Sub Main()
        ...
        Dim app_token As String = FetchAppToken()

        Console.Write(app_token)


    End Sub

    Public Function FetchAppToken()
        ' removed client_id, add back in to make functional
        ' removed client_secret, add back in to make functional
        Dim postData As String = "client_id=HlQt96tynmwYDYmatN4EyMtG23imNoQa&client_secret=5LAFGbnbEpmsABMD"
